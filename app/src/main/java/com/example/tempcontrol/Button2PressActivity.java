...
public class Button2PressActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_button2_press);
        ...
        sendData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                databaseReference.child("room1").setValue(demo.getTemp());
                Toast.makeText(Button2PressActivity.this, "desired temp added", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
...
//                    Toast.makeText(Button2PressActivity.this, "Please add desired temperature.", Toast.LENGTH_SHORT).show();
//                }
//                else {
...
//                Toast.makeText(Button2PressActivity.this, "temp added", Toast.LENGTH_SHORT).show();
//            }
//
//            @Override
//            public void onCancelled(@NonNull DatabaseError error) {
//                Toast.makeText(Button2PressActivity.this, "Fail to add temp " + error, Toast.LENGTH_SHORT).show();
//            }
//        });
//    }
//}
